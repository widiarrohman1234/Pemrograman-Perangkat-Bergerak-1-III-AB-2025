...
Future<void> main() async {
  ...
  DateTime tanggalSeakarang = DateTime.now();
  print("Tanggal hari ini: ${formatDate(tanggalSeakarang)}");

  print("------");

  // Menggunakan fungsi dari validator.dart
  String email1 = 'contoh@gmail.com';
  String email2 = 'salah_email.com';
  print('Email valid? ${isValidEmail(email1)}');
  print('Apakah email valid? ${isValidEmail(email2)}');

  print("------");
  // Menggunakan fungsi dari calculator.dart
  double hargaDiskon = calculateDiscount(100000, 20);
  print('Harga setelah diskon: $hargaDiskon'); 
